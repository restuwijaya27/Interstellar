...
export default function HomeLayout({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-base-300 via-neutral to-base-100">
      {/* Navbar */}
      <div className="navbar bg-base-200/50 backdrop-blur-sm fixed top-0 z-50">
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost text-xl">SIP UTI</a>
        </div>
      ...
      <div className="relative min-h-screen w-full pt-16">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-8">
          <div className="rounded-box bg-base-200/50 p-8 backdrop-blur-sm">
            {children}
          </div>
        </div>
      </div>
